...
case class React(generation: Int, name: String, time: Int, view: String, energy: Int, master: Option[Direction] = None, collision: Option[Direction] = None) extends ServerCommand